...
var _ = ginkgo.BeforeSuite(func() {
	...
	case util.GRPCDriver:
		...
		sourceConfigFileName, hubHash = startGRPCServer(envCtx, tempDir, cfg, "8090")
...
func startGRPCServer(ctx context.Context, temp string, cfg *rest.Config, bindPort string) (string, string) {
