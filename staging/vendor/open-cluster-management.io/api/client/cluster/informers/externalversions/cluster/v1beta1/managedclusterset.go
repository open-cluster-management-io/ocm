...
type ManagedClusterSetInformer interface {
	...
	Lister() v1beta1.ManagedClusterSetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusterV1beta1().ManagedClusterSets().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusterV1beta1().ManagedClusterSets().Watch(context.TODO(), options)
			},
		},
...
func (f *managedClusterSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clusterv1beta1.ManagedClusterSet{}, f.defaultInformer)
}

func (f *managedClusterSetInformer) Lister() v1beta1.ManagedClusterSetLister {
	return v1beta1.NewManagedClusterSetLister(f.Informer().GetIndexer())
}
