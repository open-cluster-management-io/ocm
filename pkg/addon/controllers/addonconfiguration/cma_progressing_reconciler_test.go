...
func TestMgmtAddonProgressingReconcile(t *testing.T) {
	cases := []struct {
				...
				func() *addonv1beta1.ManagedClusterAddOn {
					...
					addon.Status.ConfigReferences = []addonv1beta1.ConfigReference{
						...
						},
						{
							...
							DesiredConfig: &addonv1beta1.ConfigSpecHash{
								ConfigReferent: addonv1beta1.ConfigReferent{Name: "bar1"},
								SpecHash:       "hashbar1",
							},
							LastAppliedConfig: &addonv1beta1.ConfigSpecHash{
								ConfigReferent: addonv1beta1.ConfigReferent{Name: "bar1"},
				...
				func() *addonv1beta1.ManagedClusterAddOn {
					...
					addon.Status.ConfigReferences = []addonv1beta1.ConfigReference{
						...
						},
						{
							ConfigGroupResource: addonv1beta1.ConfigGroupResource{Group: "core", Resource: "Bar"},
							DesiredConfig: &addonv1beta1.ConfigSpecHash{
								ConfigReferent: addonv1beta1.ConfigReferent{Name: "bar-old"},
			...
			clusterManagementAddon: []runtime.Object{addontesting.NewClusterManagementAddon("test", "", "").
				...
				ConfigReferences: []addonv1beta1.InstallConfigReference{
					...
					},
					{
						ConfigGroupResource: addonv1beta1.ConfigGroupResource{Group: "core", Resource: "Bar"},
						DesiredConfig: &addonv1beta1.ConfigSpecHash{
							ConfigReferent: addonv1beta1.ConfigReferent{Name: "bar-new"},
		...
		},
		{
			...
			clusterManagementAddon: []runtime.Object{addontesting.NewClusterManagementAddon("test", "", "").
				...
				addonv1beta1.InstallProgression{
					PlacementRef: addonv1beta1.PlacementRef{Name: "placement1", Namespace: "test"},
					ConfigReferences: []addonv1beta1.InstallConfigReference{
						{
							ConfigGroupResource: addonv1beta1.ConfigGroupResource{Group: "core", Resource: "Foo"},
			...
			validateAddonActions: func(t *testing.T, actions []clienttesting.Action) {
				...
				if cma.Status.InstallProgressions[1].Conditions[0].Reason != addonv1beta1.ProgressingReasonCompleted {
	...
	for _, c := range cases {
		t.Run(c.name, func(t *testing.T) {
			...
			for _, obj := range c.clusterManagementAddon {
				graph, err := controller.buildConfigurationGraph(obj.(*addonv1beta1.ClusterManagementAddOn))
				if err != nil {
