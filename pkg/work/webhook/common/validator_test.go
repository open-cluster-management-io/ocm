...
func Test_Validator(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			expectedError: fmt.Errorf("duplicate manifest at index 1: v1/Secret/test/test (first occurrence at index 0)"),
		},
		{
		...
		},
		{
			...
			expectedError: fmt.Errorf("duplicate manifest at index 2: v1/ConfigMap/default/test1 (first occurrence at index 0)"),
		},
		{
