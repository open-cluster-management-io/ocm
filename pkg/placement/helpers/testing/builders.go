...
func (b *PlacementBuilder) AddPredicate(labelSelector *metav1.LabelSelector,
	claimSelector *clusterapiv1beta1.ClusterClaimSelector,
	celSelector *clusterapiv1beta1.ClusterCelSelector) *PlacementBuilder {
...
func NewClusterPredicate(labelSelector *metav1.LabelSelector,
	claimSelector *clusterapiv1beta1.ClusterClaimSelector,
	celSelector *clusterapiv1beta1.ClusterCelSelector) clusterapiv1beta1.ClusterPredicate {
