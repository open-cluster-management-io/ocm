...
func (c *csrControl) IsApproved(name string) (bool, error) {
...
func (c *csrControl) GetIssuedCertificate(name string) ([]byte, error) {
	csr, err := c.csrClientHolder.Clients().Get(context.Background(), name, metav1.GetOptions{})
	if err != nil {
		return nil, err
	}
...
func (c *csrControl) Create(ctx context.Context, recorder events.Recorder, objMeta metav1.ObjectMeta, csrData []byte,
...
func (c *csrControl) Informer() cache.SharedIndexInformer {
