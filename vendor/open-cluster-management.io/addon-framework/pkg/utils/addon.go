...
type ManagedClusterAddOnFilterFunc func(mca *addonapiv1beta1.ManagedClusterAddOn) bool
...
func AllowAllAddOns(mca *addonapiv1beta1.ManagedClusterAddOn) bool {
	return true
}
...
func FilterTemplateBasedAddOns(mca *addonapiv1beta1.ManagedClusterAddOn) bool {
	if mca == nil {
		return false
	}
