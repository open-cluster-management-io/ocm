...
func (in *ClusterManagerSpec) DeepCopyInto(out *ClusterManagerSpec) {
	*out = *in
	...
	if in.NetworkPolicyConfiguration != nil {
		in, out := &in.NetworkPolicyConfiguration, &out.NetworkPolicyConfiguration
		*out = new(NetworkPolicyConfiguration)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkPolicyConfiguration) DeepCopyInto(out *NetworkPolicyConfiguration) {
	*out = *in
}

func (in *NetworkPolicyConfiguration) DeepCopy() *NetworkPolicyConfiguration {
	if in == nil {
		return nil
	}
	out := new(NetworkPolicyConfiguration)
