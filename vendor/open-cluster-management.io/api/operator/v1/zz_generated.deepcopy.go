...
func (in *ClusterManagerDeployOption) DeepCopyInto(out *ClusterManagerDeployOption) {
	*out = *in
	if in.Detached != nil {
		...
		*out = new(DetachedClusterManagerConfiguration)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DetachedClusterManagerConfiguration) DeepCopyInto(out *DetachedClusterManagerConfiguration) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DetachedClusterManagerConfiguration.
func (in *DetachedClusterManagerConfiguration) DeepCopy() *DetachedClusterManagerConfiguration {
	if in == nil {
		return nil
	}
	out := new(DetachedClusterManagerConfiguration)
