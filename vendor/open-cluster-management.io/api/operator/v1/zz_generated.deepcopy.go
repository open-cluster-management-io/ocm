...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CSRDriverConfig) DeepCopyInto(out *CSRDriverConfig) {
	*out = *in
	if in.AutoApprovedIdentities != nil {
		in, out := &in.AutoApprovedIdentities, &out.AutoApprovedIdentities
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CSRDriverConfig.
func (in *CSRDriverConfig) DeepCopy() *CSRDriverConfig {
	if in == nil {
		return nil
	}
	out := new(CSRDriverConfig)
	in.DeepCopyInto(out)
	return out
}
