...
func (in *ClusterClaimSelector) DeepCopyInto(out *ClusterClaimSelector) {
	*out = *in
	...
	if in.RegexSelector != nil {
		in, out := &in.RegexSelector, &out.RegexSelector
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterLabelSelector) DeepCopyInto(out *ClusterLabelSelector) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterLabelSelector.
func (in *ClusterLabelSelector) DeepCopy() *ClusterLabelSelector {
	if in == nil {
		return nil
	}
	out := new(ClusterLabelSelector)
	in.DeepCopyInto(out)
	return out
}
