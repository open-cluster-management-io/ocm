...
type ManagedClusterAddOnLister interface {
	...
	List(selector labels.Selector) (ret []*addonv1beta1.ManagedClusterAddOn, err error)
...
type managedClusterAddOnLister struct {
	listers.ResourceIndexer[*addonv1beta1.ManagedClusterAddOn]
}
...
func NewManagedClusterAddOnLister(indexer cache.Indexer) ManagedClusterAddOnLister {
	return &managedClusterAddOnLister{listers.New[*addonv1beta1.ManagedClusterAddOn](indexer, addonv1beta1.Resource("managedclusteraddon"))}
}

// ManagedClusterAddOns returns an object that can list and get ManagedClusterAddOns.
func (s *managedClusterAddOnLister) ManagedClusterAddOns(namespace string) ManagedClusterAddOnNamespaceLister {
	return managedClusterAddOnNamespaceLister{listers.NewNamespaced[*addonv1beta1.ManagedClusterAddOn](s.ResourceIndexer, namespace)}
}
...
type ManagedClusterAddOnNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*addonv1beta1.ManagedClusterAddOn, error)
