...
// AddOnTemplateRegistrationType represents the type of the registration configuration,
// it could be KubeClient or CustomSigner
type AddOnTemplateRegistrationType string
...
const (
	...
	RegistrationTypeKubeClient AddOnTemplateRegistrationType = "KubeClient"
	...
	RegistrationTypeCustomSigner AddOnTemplateRegistrationType = "CustomSigner"
...
// If the AddOnTemplateRegistrationType type is KubeClient, the secret name will be "{addon name}-hub-kubeconfig"
// whose content includes key/cert and kubeconfig. Otherwise, If the AddOnTemplateRegistrationType type is
...
type RegistrationSpec struct {
	...
	Type AddOnTemplateRegistrationType `json:"type"`
...
type CustomSignerRegistrationConfig struct {
	...
	// }
	Subject *AddOnTemplateSubject `json:"subject,omitempty"`
...
// AddOnTemplateSubject is the user subject of the addon agent to be registered to the hub.
type AddOnTemplateSubject struct {
