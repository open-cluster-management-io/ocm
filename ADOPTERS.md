...
| End user | Groww | 2025 | [Link](https://groww.in/) | Groww uses OCM to deploy application workloads across multiple clusters for cell-based deployment architecture. They built a custom rollout controller on top of OCM that generates ManifestWork in a progressive fashion with manual control from a human operator. |
